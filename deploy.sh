...
kubectl set image deployments/server-deployment server=kshitijbahul/multi-server:$SHA
kubectl set image deployments/worker-deployment worker=kshitijbahul/multi-worker:$SHA